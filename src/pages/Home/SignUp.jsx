    ...
    return (
            ...
            <div id='signup' className={`signup  w-screen bg-black flex flex-row-reverse justify-between bg-black/[.7] absolute ${position} `}>
                <div className='h-screen w-[700px] bg-white rounded-3xl h-full relative flex flex-col'>
                    ...
                    <button className='facebooklogin w-[60%] text-center mx-auto rounded-full py-1 px-4 text-lg text-white bg-bleu-100 flex justify-between items-center'><Icon icon="bx:bxl-facebook-circle" color="white" width="32" /> Continue with Facebook</button>
                    ...
                    <button className='h-50px bg-grat text-black absolute bottom-0 p-4 mx-auto text-center'>Create a free business account</button>
                </div>
