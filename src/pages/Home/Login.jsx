...
function Login() {
    return (
        <div className='h-screen w-screen bg-black bg-black/[.7] absolute top-0 '>
            <div className='h-screen w-[500px] bg-white rounded-3xl mx-auto relative flex flex-col'>
                ...
                <p className='text-center text-xl my-2 text-[#333333]'>OR</p>
                <button className='facebooklogin w-[60%] text-center mx-auto rounded-full py-1 px-4 mt-2 text-xl text-white bg-bleu-100 flex justify-between items-center'><Icon icon="bx:bxl-facebook-circle" color="white" width="32" /> Continue with Facebook</button>
                <button className='googlelogin w-[60%] text-center mx-auto rounded-full py-1 px-4 text-lg  mt-6 text-[#333333] border-2 border-gray bg-transparent flex justify-between items-center'><Icon icon="flat-color-icons:google" color="white" width="32" />Continue with Google</button>
